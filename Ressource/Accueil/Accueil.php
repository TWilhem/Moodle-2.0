...
$stmt = $pdo->prepare("SELECT titre, image, description FROM Actualites ORDER BY id ASC");
$stmt->execute();
...
<body>
    ...
    <div class="bubble-container">
        <?php foreach ($actualites as $actu): ?>
            <div class="bubble">
                <img src="./image/<?= htmlspecialchars($actu['image']) ?>" alt="<?= htmlspecialchars($actu['titre']) ?>">
                <div class="Description">
                    <p><strong><?= htmlspecialchars($actu['titre']) ?></strong></p>
