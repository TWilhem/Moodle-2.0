document.addEventListener("DOMContentLoaded", () => {
    ...
    function bindAddLink(btn) {
        btn.addEventListener("click", () => {
            ...
            a.textContent = "Nouveau lien";
            a.dataset.annee = anneeIndex;
            a.dataset.lien = ul.querySelectorAll("a").length;
    ...
    function reindexLiens(niveau, anneeIndex = null) {
        ...
        const liens = niveau.querySelectorAll("li a[data-annee]");
...
document.getElementById('export-json').addEventListener('click', function (e) {
    ...
    niveaux.forEach(niveau => {
        ...
        const liens = [];
        niveau.querySelectorAll('ul li a').forEach(a => {
            liens.push({
