...
<body>
    ...
    <div class="bubble-container">
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image1.jpg');">
            <p>Bulle 1</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image2.jpg');">
            <p>Bulle 2</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image3.jpg');">
            <p>Bulle 3</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image4.jpg');">
            <p>Bulle 4</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image5.jpg');">
            <p>Bulle 5</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image6.jpg');">
            <p>Bulle 6</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image7.jpg');">
            <p>Bulle 7</p>
        </div>
        <div class="bubble" style="background-image: linear-gradient(to top right, rgba(0,0,0,0.4), rgba(0,0,0,0.1)), url('./Dossier/image8.jpg');">
            <p>Bulle 8</p>
        </div>
    </div>    
</body>
