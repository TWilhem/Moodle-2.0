...
if (!isset($user['autorite']) || ($user['autorite'] !== 'Admin' && $user['autorite'] !== 'Prof')) {
    header("Location: ../../Filiere/Filiere/Filiere.php");
    exit();
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="./Administration.css" type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <script src="../../script.js" defer></script>
    <script src="./Administration.js" defer></script>
</head>
<body>
    <label for="" class="label">
        ...
        <div class="right-icon">
            ...
            <div class="Menu">
                ...
                <div id="linksMenu">
                    <?php if (isset($user['autorite']) && $user['autorite'] === 'Admin'): ?>
    ...
    <div class="form-container">
        <?php include './AAdministration.php'; ?>
    </div>
</body>
</html>